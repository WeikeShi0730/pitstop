...
const FeatureProduct = ({ featuredProduct }: ProductsType) => {
  ...
  return (
    <div className="p-3 m-3 rounded-lg text-center text-slate-700 bg-opacity-100 backdrop-blur-sm bg-slate-400 transition-all duration-200 ease-in-out hover:shadow-lg hover:shadow-slate-700">
