    ...
    <div>
      ...
      >
        <Tab.List className="flex w-72 p-1 gap-x-1 bg-slate-300 rounded-lg shadow">
          <button
            className="buttonPrev w-full py-1 leading-5 text-slate-700 rounded-lg hover:bg-slate-50"
          ...
          {pageList}
          <button
            className="buttonNext w-full py-1 leading-5 text-slate-700 rounded-lg hover:bg-slate-50"
