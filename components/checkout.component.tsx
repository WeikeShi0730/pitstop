      ...
      {cartItems && cartItems.length > 0 ? (
        <>
          ...
          <div className="flex justify-center h-full">
            <button className="flex justify-center items-center w-1/5 min-w-fit m-5 px-2 rounded-lg bg-indigo-600 text-slate-200 hover:text-slate-50 hover:bg-indigo-500">
